...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Social-Distancing-Detection-in-Real-Time-main\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Social-Distancing-Detection-in-Real-Time-main\env\Scripts\deactivate.nu'
